  ...
  return (
    <div className="glass-card p-6 fade-in">
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="font-semibold text-base" style={{ color: 'var(--foreground)' }}>Live Crowd Density</h3>
        ...
        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium" style={{
          ...
          <div className="w-1.5 h-1.5 rounded-full animate-pulse" style={{ background: isConnected ? '#10b981' : '#f59e0b' }} />
      ...
      <div className="relative mx-auto" style={{ width: '100%', maxWidth: 320, aspectRatio: '1.15' }}>
        <svg viewBox="0 0 100 87" className="w-full h-full">
          ...
          {/* Field */}
          <ellipse cx="50" cy="43.5" rx="22" ry="16" fill="rgba(16, 185, 129, 0.1)" stroke="rgba(16, 185, 129, 0.3)" strokeWidth="0.3" />
          <text x="50" y="45" textAnchor="middle" fill="var(--muted)" fontSize="3.5" fontFamily="Inter">PITCH</text>
          ...
          {seatingZones.map((zone, i) => {
            ...
            return (
              <g key={zone.id}>
                ...
                <text x={x} y={y + 1.2} textAnchor="middle" fill="white" fontSize="2.8" fontWeight="600" fontFamily="Inter">
                  {label}
                </text>
              </g>
            );
